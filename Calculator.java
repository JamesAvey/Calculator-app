...
public class Calculator  implements ActionListener {
    ...
    Calculator() {
        ...
        //Creates the output/input box on the display
        ...
        // Adds each function button the array
        ...
        // iterate through the function buttons array assigning the functions to each button. */
        for (int i = 0; i < 8; i++) {
